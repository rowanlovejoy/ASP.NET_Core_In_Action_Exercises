...
// Could it be that this didn't work in ASP.NET 7? Why would this be? Interestingly, the author's own blog post contemporary with the book (the blog post advertise the book), does explain that the scoped lifetime can be used to achieve configuration reloading -- see https://andrewlock.net/adding-validation-to-strongly-typed-configuration-objects-in-dotnet-6/#avoiding-the-ioptions-dependency
